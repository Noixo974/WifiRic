  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4 animate-fade-in">
        <div
          className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-md w-full border border-gray-200 dark:border-gray-700 animate-scale-in"
          ...
          <div className="p-8 space-y-6">
            <div className="text-center space-y-2">
              <p className="text-gray-600 dark:text-gray-300">
                Connectez-vous ou inscrivez-vous avec Discord
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Accédez à votre profil et gérez vos messages
              </p>
            </div>
            ...
            >
              ...
              {isSigningIn || isLoading ? (
                ...
                <>
                  ...
                  <span className="relative">Connexion par Discord</span>
                </>
              )}
            </button>
          </div>
