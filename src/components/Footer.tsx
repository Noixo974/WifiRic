            ...
            <div className="flex flex-wrap justify-center gap-6">
              {legalLinks.map((link, index) => (
                <button
                  key={index}
                  onClick={link.action}
                  className="group relative text-sm text-gray-600 dark:text-gray-400 hover:text-[#9cd4e3] dark:hover:text-[#9cd4e3] transition-all duration-300 font-medium px-2 py-1"
                >
